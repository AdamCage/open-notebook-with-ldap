export const ruRU = {
  ...
  auth: {
    ...
    localLoginTitle: "Вход",
    localLoginDesc: "Введите имя пользователя и пароль",
    ...
    displayNamePlaceholder: "Отображаемое имя (необязательно)",
    ...
    noAccountYet: "Нет учётной записи?",
    registerLink: "Зарегистрироваться",
    registerTitle: "Создание учётной записи",
    registerDesc: "Зарегистрируйте новую учётную запись",
    registerButton: "Зарегистрироваться",
    registering: "Регистрация...",
    alreadyHaveAccount: "Уже есть учётная запись?",
    passwordMismatch: "Пароли не совпадают",
    passwordTooShort: "Пароль должен содержать не менее 6 символов",
    pendingTitle: "Учётная запись ожидает подтверждения",
    pendingDesc: "Ваша учётная запись создана и ожидает одобрения администратора. Вы сможете войти после активации учётной записи.",
    backToLogin: "Вернуться к входу",
    accountPending: "Ваша учётная запись ожидает одобрения администратора",
    accountDeactivated: "Ваша учётная запись деактивирована",
  },
  navigation: {
    collect: "Собрать",
    process: "Обработать",
  ...
  admin: {
    ...
    usersDesc: "Управление учётными записями, подтверждение регистраций и назначение ролей.",
