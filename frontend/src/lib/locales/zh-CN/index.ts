export const zhCN = {
  ...
  auth: {
    ...
    localLoginTitle: "Sign In",
    localLoginDesc: "Enter your username and password",
    ...
    registerDesc: "Register for a new account",
    ...
    pendingDesc: "Your account has been created and is awaiting administrator approval. You will be able to sign in once your account has been activated.",
  ...
  admin: {
    ...
    usersDesc: "Manage user accounts, approvals, and roles.",
